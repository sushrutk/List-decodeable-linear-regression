...
\begin{document}
	...
	\input{scontent/intro}
	\input{scontent/results}
	\input{scontent/overview}
	\input{scontent/prelims}
	\input{scontent/algorithm}
	\input{scontent/lower-bound}
